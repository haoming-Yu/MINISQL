...
protected:
  ...
  TypeId type_id_;
  uint32_t len_; // when field is TypeChar, need to keep the length of the char* chars_ in this member.
  bool is_null_{false}; // keep the state to indicate whether the field is null

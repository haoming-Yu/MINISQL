...
private:
  ...
  bool Coalesce(N **neighbor_node, N **node, BPlusTreeInternalPage<KeyType, page_id_t, KeyComparator> **parent,
                int index, Transaction *transaction = nullptr,bool IsChange=false);
  ...
  //Reset Parent of the old_node and new_node
  void ResetParent(page_id_t &old_node, page_id_t &new_node, page_id_t &new_parent);
  void TrackPage2(page_id_t root_page_id_, BufferPoolManager *buffer_pool_manager_);
  // member variable

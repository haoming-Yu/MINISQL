...
// here the reinterpret_cast means that: the bit pattern ==(interpreted as)==> Type* type, the return 
// value of reinterpret_cast<Type *>(Buf) is a pointer of Type* -> Thus, *reinterpret_cast<Type *>(Buf) expression
// visit the contents where reinterpret_cast<Type *>(Buf) points to. And write Data into the position where the pointer
// points to.
